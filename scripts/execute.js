...
export function executeMemeAssemblyCode(translateMemeAssemblyCode, assembleX86Code, codeInput, lineCallback, syscallWrite, syscallRead) {
    return __awaiter(this, void 0, void 0, function* () {
        let x86Code = yield translateMemeAssemblyCode(codeInput, lineCallback);
        console.log("Translated output:\n", x86Code);
        const code_start = 0x100000;
        const stack_start = 0x10000;
        const data_start = 0x1000;
        let x86Assembled = yield assembleX86Code(x86Code, BigInt(code_start), BigInt(data_start), "main");
        ...
        try {
            ...
            while (true) {
                ...
                syscallBuffer = yield syscallRead(syscallReadCount);
            }
            if (!normal_end) {
