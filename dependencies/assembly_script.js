...
* @returns {any}
*/
export function assemble(input_file_content, instr_start_address, data_start_address, entrypoint) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(input_file_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        uint64CvtShim[0] = instr_start_address;
        const low1 = u32CvtShim[0];
        const high1 = u32CvtShim[1];
        uint64CvtShim[0] = data_start_address;
        const low2 = u32CvtShim[0];
        const high2 = u32CvtShim[1];
        const ptr3 = passStringToWasm0(entrypoint, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        wasm.assemble(retptr, ptr0, len0, low1, high1, low2, high2, ptr3, len3);
...
export class DataSectionEntry {
    ...
    free() {
        ...
        wasm.__wbg_datasectionentry_free(ptr);
    }
}
/**
*/
export class EncodeResult {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_encoderesult_free(ptr);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('assembly_script_bg.wasm', import.meta.url);
    }
    const imports = getImports();
